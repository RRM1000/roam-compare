...
/**
 * Airalo prices, rechecked on 10 September 2026 against each destination page.
 *
 ...
 * "Lower speed rate of 1 Mbps after 3 GB usage per day" — except Spain, which since
 * this recheck says 5 GB.
 *
 ...
 */
export const AIRALO_CHECKED_AT = "2026-09-10";
export const AIRALO_REVIEW_AFTER = "2026-09-17";
...
export const airaloPlans: Plan[] = [
  ...
  airaloPlan({ id: "united-states-airalo-unlimited-7d", destination: "united-states", name: "Unlimited", unlimited: true, validity: 7, price: 19.5, network: "T-Mobile", sourceUrl: "https://www.airalo.com/united-states-esim", dailyDataGb: 3, speedCap: "1Mbps once you've used 3GB in a day", fairUse: "3GB at full speed each day, then 1Mbps until it resets", note: "Slows down after a daily limit" }),
  ...
  airaloPlan({ id: "united-states-airalo-unlimited-15d", destination: "united-states", name: "Unlimited", unlimited: true, validity: 15, price: 35.5, network: "T-Mobile", sourceUrl: "https://www.airalo.com/united-states-esim", dailyDataGb: 3, speedCap: "1Mbps once you've used 3GB in a day", fairUse: "3GB at full speed each day, then 1Mbps until it resets", note: "Slows down after a daily limit" }),
  airaloPlan({ id: "united-states-airalo-unlimited-30d", destination: "united-states", name: "Unlimited", unlimited: true, validity: 30, price: 52, network: "T-Mobile", sourceUrl: "https://www.airalo.com/united-states-esim", dailyDataGb: 3, speedCap: "1Mbps once you've used 3GB in a day", fairUse: "3GB at full speed each day, then 1Mbps until it resets", note: "Slows down after a daily limit" }),
  ...
  airaloPlan({ id: "spain-airalo-unlimited-5d", destination: "spain", name: "Unlimited", unlimited: true, validity: 5, price: 13, network: "Orange", sourceUrl: "https://www.airalo.com/spain-esim", dailyDataGb: 5, speedCap: "1Mbps once you've used 5GB in a day", fairUse: "5GB at full speed each day, then 1Mbps until it resets", note: "Slows down after a daily limit" }),
  airaloPlan({ id: "spain-airalo-unlimited-7d", destination: "spain", name: "Unlimited", unlimited: true, validity: 7, price: 18, network: "Orange", sourceUrl: "https://www.airalo.com/spain-esim", dailyDataGb: 5, speedCap: "1Mbps once you've used 5GB in a day", fairUse: "5GB at full speed each day, then 1Mbps until it resets", note: "Slows down after a daily limit" }),
  airaloPlan({ id: "spain-airalo-unlimited-10d", destination: "spain", name: "Unlimited", unlimited: true, validity: 10, price: 24.5, network: "Orange", sourceUrl: "https://www.airalo.com/spain-esim", dailyDataGb: 5, speedCap: "1Mbps once you've used 5GB in a day", fairUse: "5GB at full speed each day, then 1Mbps until it resets", note: "Slows down after a daily limit" }),
  ...
  airaloPlan({ id: "spain-airalo-unlimited-30d", destination: "spain", name: "Unlimited", unlimited: true, validity: 30, price: 48, network: "Orange", sourceUrl: "https://www.airalo.com/spain-esim", dailyDataGb: 5, speedCap: "1Mbps once you've used 5GB in a day", fairUse: "5GB at full speed each day, then 1Mbps until it resets", note: "Slows down after a daily limit" }),
  // japan — Softbank
  ...
  airaloPlan({ id: "united-arab-emirates-airalo-unlimited-5d", destination: "united-arab-emirates", name: "Unlimited", unlimited: true, validity: 5, price: 14.5, network: "Etisalat", sourceUrl: "https://www.airalo.com/united-arab-emirates-esim", dailyDataGb: 3, speedCap: "1Mbps once you've used 3GB in a day", fairUse: "3GB at full speed each day, then 1Mbps until it resets", note: "Slows down after a daily limit" }),
