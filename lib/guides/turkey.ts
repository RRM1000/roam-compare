...
export const turkeyGuide: DestinationGuide = {
  ...
  sources: [
    { id: "o2-travel", label: "O2 Travel", url: "https://www.o2.co.uk/international/o2-travel", publisher: "O2", checkedAt: "2026-09-10", reviewAfter: "2026-10-10", kind: "operator" },
    { id: "three-turkey", label: "Roaming abroad: Turkey, pay monthly", url: "https://www.three.co.uk/support/roaming-and-calling-abroad/roaming-abroad?country=Turkey&plan=paym", publisher: "Three", checkedAt: "2026-09-10", reviewAfter: "2026-10-10", kind: "operator" },
    { id: "vodafone-global-roaming", label: "Global roaming destinations", url: "https://www.vodafone.co.uk/mobile/global-roaming", publisher: "Vodafone", checkedAt: "2026-09-10", reviewAfter: "2026-10-10", kind: "operator" },
    { id: "giffgaff-turkiye", label: "Roaming charges in Türkiye", url: "https://www.giffgaff.com/roaming/turkiye", publisher: "giffgaff", checkedAt: "2026-09-10", reviewAfter: "2026-10-10", kind: "operator" },
    { id: "airalo-turkey", label: "Turkey eSIM", url: "https://www.airalo.com/turkey-esim", publisher: "Airalo", checkedAt: "2026-09-10", reviewAfter: "2026-10-10", kind: "provider" },
    { id: "nomad-turkey", label: "Turkey eSIM", url: "https://www.nomadesim.com/turkey-eSIM", publisher: "Nomad", checkedAt: "2026-09-10", reviewAfter: "2026-10-10", kind: "provider" },
    { id: "klook-turkey", label: "Turkey eSIM (QR code voucher)", url: "https://www.klook.com/en-GB/activity/128551-turkey-esim-high-speed-internet-qr-code-voucher/", publisher: "Klook", checkedAt: "2026-08-25", reviewAfter: "2026-10-10", kind: "provider" },
    { id: "holafly-ban", label: "Turkey bans global eSIM providers (updated 7 August 2026)", url: "https://esim.holafly.com/news/esim-ban-turkey/", publisher: "Holafly", checkedAt: "2026-09-10", reviewAfter: "2026-12-09", kind: "press" },
    { id: "findyouresim-ban", label: "Turkey blocks access to popular eSIM providers (July 2025)", url: "https://findyouresim.com/news/turkey-blocks-access-to-popular-esim-providers-as-holiday-season-begins/", publisher: "Find Your eSIM", checkedAt: "2026-09-10", reviewAfter: "2026-12-09", kind: "press" },
    { id: "developing-telecoms-5g", label: "Turkcell, Türk Telekom and Vodafone Turkey launch 5G services (April 2026)", url: "https://developingtelecoms.com/telecom-technology/wireless-networks/20062-turkcell-turk-telekom-and-vodafone-turkey-launch-5g-services.html", publisher: "Developing Telecoms", checkedAt: "2026-09-10", reviewAfter: "2026-12-09", kind: "press" },
    { id: "daily-sabah-5g", label: "Türkiye due to hold 5G tender, service available as of April 2026 (October 2025)", url: "https://www.dailysabah.com/business/tech/turkiye-due-to-hold-5g-tender-service-to-be-available-as-of-april-2026", publisher: "Daily Sabah", checkedAt: "2026-09-10", reviewAfter: "2026-12-09", kind: "press" },
    { id: "turkiye-today-imei", label: "Türkiye sets 2026 IMEI registration fee for imported phones (1 January 2026)", url: "https://www.turkiyetoday.com/business/turkiye-sets-2026-imei-registration-fee-for-phones-brought-from-abroad-at-1263-3212215", publisher: "Türkiye Today", checkedAt: "2026-09-10", reviewAfter: "2026-12-09", kind: "press" },
    { id: "simology-imei", label: "Turkey IMEI registration 2026: tourist guide", url: "https://simology.io/blog/turkey-imei-registration-tourists-deadlines-fees-workarounds-2026", publisher: "Simology", checkedAt: "2026-09-10", reviewAfter: "2026-12-09", kind: "press" },
    { id: "traveltomtom-airport", label: "Buying a SIM card at Istanbul Airport in 2026 (checked September 2026)", url: "https://www.traveltomtom.net/destinations/europe/turkey/turkey-sim-card-istanbul-airport", publisher: "Traveltomtom", checkedAt: "2026-09-10", reviewAfter: "2026-12-09", kind: "press" },
    { id: "roamless-wifi", label: "Istanbul Airport Wi-Fi (updated 13 August 2026)", url: "https://roamless.com/blog/istanbul-airport-wifi", publisher: "Roamless", checkedAt: "2026-09-10", reviewAfter: "2026-12-09", kind: "press" },
    { id: "travel-weekly-visits", label: "Turkey attracted 64m tourists in 2025 but UK arrivals dip (4 February 2026)", url: "https://travelweekly.co.uk/news/turkey-attracted-64m-tourists-in-2025-but-uk-arrivals-dip", publisher: "Travel Weekly", checkedAt: "2026-09-10", reviewAfter: "2027-03-10", kind: "press" },
    { id: "techradar-blackout", label: "X, WhatsApp, YouTube and other platforms go dark in Turkey for 24 hours", url: "https://www.techradar.com/vpn/vpn-privacy-security/x-whatsapp-youtube-and-other-social-media-platforms-go-dark-in-turkey-and-vpn-usage-spikes", publisher: "TechRadar", checkedAt: "2026-09-10", reviewAfter: "2026-12-09", kind: "press" },
  ],
