...
export default function Home() {
  ...
  useEffect(() => {
    ...
    const queryDays = Number(params.get("days"));
  ...
  async function shareComparison() {
    ...
    try {
      ...
      setShareStatus("Shareable link added to the address bar");
    }
  }
  ...
  return (
    <main>
      <nav className="nav-shell" aria-label="Main navigation">
        ...
        <div className="nav-actions"><span className="nav-note">Built for UK travellers</span><a href="#methodology">Our data</a><a href="#faq">FAQ</a><a href="/about">About</a></div>
      </nav>
      ...
      <footer><a className="brand" href="#top"><span className="brand-mark">RC</span><span>RoamCompare</span></a><p>Independent comparisons for UK travellers · prices checked {DATA_CHECKED}</p><div className="footer-links"><a href="/about">About & disclosure</a><a href="/privacy">Privacy</a><a href="/terms">Terms</a></div></footer>
    </main>
  );
}
