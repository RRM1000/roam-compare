...
export default function PrivacyPage() {
  return <InfoPage eyebrow="Privacy" title="We don’t ask who you are" updated="16 Aug 2026" intro="RoamCompare works out your comparison in your browser. There is no account, and we do not build a profile of you.">
