...
export default function PrivacyPage() {
  return <InfoPage eyebrow="Privacy" title="We don’t ask who you are" updated="25 Aug 2026" intro="RoamCompare works out your comparison in your browser. There is no account, and we do not build a profile of you.">
    ...
    <section><h2>Cookies and analytics</h2><p>RoamCompare sets no cookies at all and loads no scripts from anyone else — no analytics, no advertising, no tag manager. Nothing is stored in your browser until you use &ldquo;Save on this device&rdquo;. The hosting service may process ordinary technical request data needed to deliver and secure the site.</p></section>
