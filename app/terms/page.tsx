...
export default function TermsPage() {
  return <InfoPage eyebrow="Terms of use" title="Check before you buy" intro="These terms cover the current working build of RoamCompare. Our results are here to help you decide — they are not a quote, and they are not a guarantee.">
