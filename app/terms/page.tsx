...
export default function TermsPage() {
  return <InfoPage eyebrow="Terms of use" title="Check before you buy" updated="16 Aug 2026" intro="These terms cover the current working build of RoamCompare. Our results are here to help you decide — they are not a quote, and they are not a guarantee.">
